 ...
 */
	_gsScope._gsDefine("plugins.CSSPlugin", ["plugins.TweenPlugin","TweenLite"], function(TweenPlugin, TweenLite) {
		...
		var _getFormatter = function(dflt, clr, collapsible, multi) {
			 ...
			 * _sp.parseComplex(element, "boxShadow", "5px 10px 20px rgb(255,102,51)", "0px 0px 0px red", true, "0px 0px 0px rgb(0,0,0,0)", pt);
		 ...
		 * this._firstPT = _sp.parse(element, "5px 10px 20px rgb(2550,102,51)", "boxShadow", this);
